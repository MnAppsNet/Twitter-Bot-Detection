...
def f_max_min_tweets_per_day(data:data):
    ...
    if c != None:
        return get_statistical_results_of_list(np.array(list(c.values())).flatten(),'max_min_tweets_per_day')
        ...
        return get_statistical_results_of_list([],'max_min_tweets_per_day')
...
def f_average_time_between_tweets(data:data):
    ...
    for i in range(0, len(tweets) - 1):
        ...
        gapList.append(gap)
    return get_statistical_results_of_list(gapList,'average_time_between_tweets')
