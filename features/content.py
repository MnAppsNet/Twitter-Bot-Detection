...
def f_marks_distribution(data:data):
    ...
    return get_statistical_results_of_list(marksPerTweet,'marks_distribution')
...
def get_average_marked_as_favorite(data:data):
    ...
    return get_statistical_results_of_list(favs,'average_marked_as_favorite')
...
def get_retweeted(data:data):
    ...
    return get_statistical_results_of_list(rts,'retweeted')
...
def get_statistics_of_their_retweets(data:data):
    ...
    return get_statistical_results_of_list(rts,'statistics_of_their_retweets')